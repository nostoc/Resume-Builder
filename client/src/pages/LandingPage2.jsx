          ...
          <div className="flex-1 flex flex-col items-start md:mb-0 pr-4">
            ...
            <ol className="list-decimal list-inside space-y-4 text-lg text-slate-700 mb-8">
              <li className="relative pl-6 font-semibold text-xl">
                Enter your details to create a personalized resume that
                highlights your strengths.
              </li>
              <li className="relative pl-6 font-semibold text-xl">
                Pick a professional template that suits your style and career
                goals.
              </li>
              <li className="relative pl-6 font-semibold text-xl">
                Download your resume, print it, and get ready to impress
                employers!
              </li>
            </ol>
